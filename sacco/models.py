...
def generate_unique_name(instance, filename):   #for generating unique name for uploaded images
    #kenya.png rtutyuryturyru-kenya.png
    name= uuid.uuid4()
...
#python manage.py populate .....for populating a database